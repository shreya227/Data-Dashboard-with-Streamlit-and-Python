...
DATA_URL = ("C:\\Users\\Shreya\\Downloads\\Tweets.csv")
...
if not st.sidebar.checkbox('Close', True, key = '3'):
    ...
    wordcloud = WordCloud(stopwords= STOPWORDS, background_color='lightblue',height=640, width=800).generate(pro_words)
